...
export function buildSurveyReportXml(
  ...
  // ── Sheet 1: Summary ────────────────────────────────────────────────────────
  const summaryRows = [
    rowXml([{ v: 'IFFS 2026 Biennial Survey — Surveillance Report', style: 'title' }]),
    ...
    rowXml([{
      v:
        `${INVITED_COUNTRIES} countries were invited to participate in the IFFS 2026 Biennial Survey. ` +
