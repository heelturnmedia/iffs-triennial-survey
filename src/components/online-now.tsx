...
// Vendored fix: the registry shipped this as "@/components/../../components/indicator",
// a malformed path that resolves outside src/ and does not compile. The component
// is a real registry item (@efferd/indicator), added separately.
