        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            <section>
              ...
              <p>
                By accessing or using the IFFS 2027 Biennial Survey platform ("the Platform"), you
            ...
            <section>
              ...
              <p className="mb-3">You agree to use the Platform solely for its intended purpose of completing the IFFS 2027 Biennial Survey. You must not:</p>
